...
a boomerang can be defined as: sub-array of length 3, with the first and last digits 
...
Notes
[5, 5, 5] (triple identical digits) is NOT considered a boomerang because 
the middle digit is identical to the first and last.
...
console.log(countBoomerangs([4, 4, 4, 9, 9, 5, 9]))
