...
Create a function that gets the name of the piece of jewelry 
with the highest price and returns "The most expensive one is the {name of jewelry piece}".
...
function mostExpensive(obj) {
  let max_price = Math.max(...Object.values(obj));
  let jewelry = Object.entries(obj).find((e) => e[1] === max_price)[0];
