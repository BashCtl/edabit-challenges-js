...
Given an object with alcoholic drinks and a number, return a string 
with the name of the Rammstein bottle that matches the given number.
...
function getVodkaBottle(obj, num) {
  for (let [key, vlaue] of Object.entries(obj)) {
    if (vlaue == num && key.includes("Rammstein")) {
      return key;
    }
  }
}
