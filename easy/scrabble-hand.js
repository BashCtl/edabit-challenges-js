...
score a player can achieve by summing up the total number of points for 
all the tiles in their hand. Each hand contains 7 scrabble tiles.
...
function maximumScore(tileHand){
    return tileHand.reduce((a, c)=> a + c['score'],0);
}
